...
export function Rename() {
  ...
  const selectDirectory = (set: (e: string) => void) => {
    window.Main.selectDirectory()

    window.Main.on('selected-directory', (folder: string) => set(folder))
  }
  ...
  return (
    <Form onSubmit={onSubmitRename}>
      ...
      <div className="field">
        ...
        <button
          type="button"
          onClick={() => selectDirectory(setRenameFolderPath)}
        >
          <FcOpenedFolder />
        </button>
      </div>
      <div className="field">
        ...
        <button
          type="button"
          onClick={() => selectDirectory(setDestinyFolderPath)}
        >
          <FcOpenedFolder />
        </button>
      </div>
